...
addon_info = {
	...
	# Must be the latest RELEASED STABLE NVDA version for the stable store
	# channel. 2026.2 was rejected as "not stable yet"; 2026.1 is the current
	# stable. Do not raise this above the newest stable release.
